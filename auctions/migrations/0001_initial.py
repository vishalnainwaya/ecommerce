# Generated by Django 3.0.8 on 2020-08-21 11:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestart', models.DateTimeField(default=datetime.datetime(2020, 8, 21, 16, 38, 13, 555546))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bidprice', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('timestamp', models.DateTimeField(default=datetime.datetime(2020, 8, 21, 16, 38, 13, 555546))),
